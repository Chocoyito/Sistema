...
namespace Sistema.Datos
{
    public class DT_tbl_Empleado
    {
        ...
        public bool guardarUsuario(tbl_Empleado emp)
        {
            ...
            sb.Append("(correoPersonal, correoLaboral, telefono, nombre, ciudad, apellido, cedula, direccion, idCargo, idHorario)");
            sb.Append("VALUES('" + emp.CorreoPersonal + "','" + emp.CorreoLaboral + "','" + emp.Telefono + "','" + emp.Nombre + "','" + 
            emp.Ciudad + "','" + emp.Apellido + "','"  + emp.Cedula + "','" + emp.Direccion + "', 1, 2);");
